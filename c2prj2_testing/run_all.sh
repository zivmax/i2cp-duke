...
run_test(){
    ...
    testfile="$2"
    IFS=$'\n'
    IFS=" " correct=`/home/ziv/cs/Courses/coursera/duke_c/c2prj2_testing/poker/correct-test-eval $testfile 2>&1`
...
found=0
notfound=0
for i in /home/ziv/cs/Courses/coursera/duke_c/c2prj2_testing/poker/test-eval-*
do
